Feature: Ript DSL
  ...
  Scenario: Basic DNAT forward
    ...
    Then the output should match:
      ...
      iptables --insert partition-a --destination 192.168.19.2 --jump bar-a\w+
      """
    Then the created chain name in all tables should match
  ...
  Scenario: DNAT forward with source port to different destination port
    ...
    Then the output should match:
      ...
      iptables --append foo-a\w+ --protocol TCP --destination 192.168.38.2 --dport 9876 --jump ACCEPT
      ...
      iptables --append foo-a\w+ --protocol TCP --destination 192.168.38.2 --dport 4443 --jump ACCEPT
      """
    Then the created chain name in all tables should match
  ...
  Scenario: DNAT forward for multiple sources
    ...
    Then the output should match:
      ...
      iptables --append bar-a\w+ --protocol TCP --destination 192.168.27.88 --dport 80 --jump ACCEPT
    ...
    Then the output should match:
      ...
      iptables --insert partition-a --destination 192.168.27.88 --jump bar-a\w+
      """
    Then the created chain name in all tables should match
  ...
  Scenario: DNAT forward with an explicit from
    ...
    Then the output should match:
      ...
      iptables --append bar-a\w+ --protocol TCP --destination 192.168.27.66 --dport 80 --jump ACCEPT
      iptables --table nat --insert partition-d --destination 172.23.0.95 --jump bar-d\w+
      iptables --insert partition-a --destination 192.168.27.66 --jump bar-a\w+
      """
    Then the created chain name in all tables should match
  ...
  Scenario: DNAT forward with multiple froms
    ...
    Then the output should match:
      ...
      iptables --append joeblogsco-a\w+ --protocol TCP --destination 192.168.27.66 --dport 80 --jump ACCEPT
      ...
      iptables --insert partition-a --destination 192.168.27.66 --jump joeblogsco-a\w+
      """
    Then the created chain name in all tables should match
  ...
  Scenario: DNAT forward with an explicit from and ports
    ...
    Then the output should match:
      ...
      iptables --append bar-a\w+ --protocol TCP --destination 192.168.27.66 --dport 82 --jump ACCEPT
      iptables --table nat --insert partition-d --destination 172.23.0.95 --jump bar-d\w+
      iptables --insert partition-a --destination 192.168.27.66 --jump bar-a\w+
      """
    Then the created chain name in all tables should match
  ...
  Scenario: DNAT forward with an explicit from and port mappings
    ...
    Then the output should match:
      ...
      iptables --append bar-a\w+ --protocol TCP --destination 192.168.27.66 --dport 2011 --jump ACCEPT
      iptables --table nat --insert partition-d --destination 172.23.0.95 --jump bar-d\w+
      iptables --insert partition-a --destination 192.168.27.66 --jump bar-a\w+
      """
    Then the created chain name in all tables should match
  ...
  Scenario: DNAT forward with explicit protocols
    ...
    Then the output should match:
      ...
      iptables --append cpm-a\w+ --protocol udp --destination 192.168.0.133 --dport 53 --jump ACCEPT
      ...
      iptables --append cpm-a\w+ --protocol tcp --destination 192.168.0.133 --dport 53 --jump ACCEPT
      iptables --table nat --insert partition-d --destination 172.18.88.33 --jump cpm-d\w+
      iptables --insert partition-a --destination 192.168.0.133 --jump cpm-a\w+
      """
    Then the created chain name in all tables should match
  ...
  Scenario: Basic SNAT forward
    ...
    Then the output should match:
      ...
      iptables --append bar-a\w+ --source 10.30.0.0/24 --jump ACCEPT
      iptables --table nat --insert partition-s --source 10.30.0.0/24 --jump bar-s\w+
      iptables --insert partition-a --source 10.30.0.0/24 --jump bar-a\w+
      """
    Then the created chain name in all tables should match
  ...
  Scenario: SNAT forward with an explicit from
    ...
    Then the output should match:
      ...
      iptables --append bar-a\w+ --source 10.55.0.45 --jump ACCEPT
      iptables --table nat --append bar-s\w+ --source 10.55.0.0/24 --jump SNAT --to-source 172.23.0.95
      iptables --append bar-a\w+ --source 10.55.0.0/24 --jump ACCEPT
      iptables --table nat --insert partition-s --source 10.55.0.45 --jump bar-s\w+
      iptables --table nat --insert partition-s --source 10.55.0.0/24 --jump bar-s\w+
      iptables --insert partition-a --source 10.55.0.45 --jump bar-a\w+
      iptables --insert partition-a --source 10.55.0.0/24 --jump bar-a\w+
      """
    Then the created chain name in all tables should match
